...
export default function GeminiDemoClient() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <span className="text-xl font-bold text-white">🏪 レストランデザインAI</span>
                <p className="text-xs text-white/60 mt-0.5">飲食店のデザインを効率的に生成・編集</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link
                href="/"
                className="text-white/80 hover:text-white px-4 py-2 text-sm font-medium rounded-lg transition-all hover:bg-white/10"
              >
                ← ホームに戻る
              </Link>
            </div>
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 placeholder-gray-500 resize-none"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <label htmlFor="images" className="cursor-pointer">
                      <div className="flex items-center space-x-2 px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                        <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span className="text-sm font-medium text-gray-700">画像を追加</span>
                      </div>
                      <input
                        id="images"
                        type="file"
                    ...
                    {hasCompletedInitialDesign && (
                      <>
                        ...
                        >
                          ...
                          <span className="text-sm font-medium text-orange-700">料理変更</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-sm font-medium text-blue-700">雰囲気変更</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-sm font-medium text-green-700">要素を追加</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-sm font-medium text-purple-700">要素を置き換え</span>
                        </button>
